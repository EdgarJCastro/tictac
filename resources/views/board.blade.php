    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="profile-info">
                    <div class="profile-username">
                        {{ $user->id == $nextTurn->player_id ? "Tu turno" : "Esperando a tu oponente" }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="/home" id="exit-button" class="btn btn-lg btn-primary" style="display: none;">Abandonar juego</a>
            </div>
        </div>
    </div>
    {{ csrf_field() }}
...
@section('scripts')
    <script language="JavaScript">
        ...
        gameOverChannel.bind('App\\Events\\GameOver', function(data) {
            ...
            $('#block-' + data.location).attr('checked', true);
            if(data.result == 'win') {
                $('.profile-username').html('Perdiste');
            } else {
